...
- [Simple Picture in Picture Mode App](https://github.com/ilya-shevtsov/PictureInPictureModeApp) (VideoView, **PictureInPicture**, PictureInPictureParams, Uri, Compose)
